...
const ListAllPacks = () => {
  ...
  return (
    <S.Container>
      <h2>Embalagens disponíveis</h2>
      <h1>Escolha sua embalagem e depois o sabor</h1>
      <p>
        Selecione sua embalagem e depois o sabor para fazer sua encomenda. Temos
        mais de 30 sabores disponíveis e 3 tipos de embalagens.
      </p>
      <S.ListProducts>
        {products.map(
          ({
